...
mod ownership {
    ...
    fn test_set_pending_owner() {
        ...
        let wasm_msg = wasm_execute_msg(&staker_contract.addr(), &msg);
    ...
    fn test_set_pending_owner_twice() {
        ...
        // First change owner
        let first_msg = ExecuteMsg::SetPendingOwner { new_owner };
        let wasm_msg = wasm_execute_msg(&staker_contract.addr(), &first_msg);
        ...
        let wasm_msg = wasm_execute_msg(&staker_contract.addr(), &second_msg);
    ...
    fn test_claim_ownership() {
        ...
        let is_owner_response: GetIsOwnerResponse = app
            ...
            .query_wasm_smart(
                ...
                &QueryMsg::IsOwner { addr: new_owner },
            )
            .unwrap();
    ...
    fn test_claim_ownership_with_non_pending_owner_fails() {
        ...
        // set pending owner
        let msg = ExecuteMsg::SetPendingOwner { new_owner };
        let wasm_msg = wasm_execute_msg(&staker_contract.addr(), &msg);
